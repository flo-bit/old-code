...
const hueMultiplier = 450.0;    // particles will multiply noise result 
                                // by this to get hue
...
function calculateForce(x,y,z) {
    return sin(x*0.01) * cos(y * .01) * sin(z * 1);//min(1,max(0,x*scl));//noise(x*scl+xMove,y*scl+yMove,z+zMove);
}
